...
import { proxyCall, proxySend, solidityBytesToString, valueToInt } from './BaseWrapper'
...
export class DowntimeSlasherWrapper extends BaseSlasher<DowntimeSlasher> {
   ...
   * @param length Length of downtime. Determinedc from minimum slashable downtime if not provided.
   */
